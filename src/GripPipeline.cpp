...
void GripPipeline::Process(cv::Mat& source0){
	...
	double hslThresholdLuminance[] = {32.10431654676259, 187.55119453924914};
	...
	double filterContoursMinWidth = 1000;  // default Double
	double filterContoursMaxWidth = 1.0E9;  // default Double
	double filterContoursMinHeight = 100;  // default Double
	double filterContoursMaxHeight = 1000000.0;  // default Double
